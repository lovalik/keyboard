  ...
  return `  <div class='keyboard'>
                            ...
                            <div class='keyboard-buttons_wrapper'>
                              <div class='keyboard__buttons'>
                                ...
                                <div class='forth-row'>
                                  ...
                                  <div class='button key_ArrowUp'>${dictionary.ArrowUp}</div>
                                ...
                                <div class='fifth-row'>
                                  ...
                                  <div class='button key_ArrowLeft'>${dictionary.ArrowLeft}</div>
                                  <div class='button key_ArrowDown'>${dictionary.ArrowDown}</div>
                                  <div class='button key_ArrowRight'>${dictionary.ArrowRight}</div>
                            ...
                            <div class='message'>
                              <div class='message_change-language'>
                                ...
                                <span class='message_language'>${dictionary.language}</span>
                              </div>
                            </div>
